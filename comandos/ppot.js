/*
Otro codigo del famoso juego piedra papel o tijera, o como le digan en su país
Solo que en este estaremos usando un diccionario (o collecion o array o como sea) para determinar el ganador
No como la mayoria de los codigos que he visto que usan demasiados if, else if, switch 
Soy nuevo en Javascript, así que disculpenme si no sé algunos terminos basicos y tal
*/
...
module.exports.run = async (client, message, args) => {
  ...
  */
  ...
  if (!args[0] in moves) return message.reply("Elige una opcion valida");
